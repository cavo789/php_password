    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="container">
                ...
                function (<a href="https://www.atyantik.com/managing-passwords-correct-way-php/" target="_blank" rel="noopener noreferrer">read more</a>).</p>
                <p>MD5 should be avoided since there are plenty of md5 dictionaries for helping to "crack" MD5 passwords 
                    like f.i. https://crackstation.net/.</p>
                <p>Note: since password_hash() is native, therefore there are no dependencies with an external library.</p>

                <div class="form-group">
                    <label for="PWD">So, please enter below the character string you want to use as password:</label>
